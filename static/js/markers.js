image1 = new google.maps.MarkerImage(
    '/static/img/m_startup.png',
...
image2 = new google.maps.MarkerImage(
    '/static/img/m_inversor.png',
    new google.maps.Size(27,48),
    new google.maps.Point(0,0),
    new google.maps.Point(14,48)
);

image3 = new google.maps.MarkerImage(
    '/static/img/m_coworking.png',
    new google.maps.Size(27,48),
    new google.maps.Point(0,0),
    new google.maps.Point(14,48)
);

image4 = new google.maps.MarkerImage(
    '/static/img/m_evento.png',
    new google.maps.Size(27,48),
    new google.maps.Point(0,0),
    new google.maps.Point(14,48)
);

image5 = new google.maps.MarkerImage(
    '/static/img/m_incubadora.png',
    new google.maps.Size(27,48),
    new google.maps.Point(0,0),
    new google.maps.Point(14,48)
);

image6= new google.maps.MarkerImage(
    '/static/img/m_aceleradora.png',
    new google.maps.Size(27,48),
    new google.maps.Point(0,0),
    new google.maps.Point(14,48)
);

image7 = new google.maps.MarkerImage(
    '/static/img/m_universidad.png',
    new google.maps.Size(27,48),
    new google.maps.Point(0,0),
    new google.maps.Point(14,48)
);
